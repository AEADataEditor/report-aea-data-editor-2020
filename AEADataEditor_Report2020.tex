...
\begin{table}[]
    ...
    \begin{tablenotes}
    \textit{Notes:} Data for requests received between \firstday{} and \lastday{}. AEA P+P do not generate a report, and are thus not counted under completed (cplt). (pend.) indicates that a manuscript has been marked ready for publication, and may have been published (separate report forthcoming).
    \end{tablenotes}
 \end{threeparttable}
   \end{table}
