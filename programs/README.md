...
- `data/jira`: 
   ...
   - `anon`: Anonymized subset of the internal data used to generate all figures and tables. Download data from Vilhuber(2020x) and save into this folder. `04_jira_anonymize.R` was used to anonymize these data.
...
- Note that in the absence of the raw (confidential) data files used in  `04_jira_anonymize.R`, that step will be skipped. This is normal.
